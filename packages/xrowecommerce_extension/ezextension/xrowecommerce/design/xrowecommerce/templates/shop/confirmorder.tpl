...
<div class="shop shop-confirmorder">
    <form method="post" action={"xrowecommerce/confirmorder"|ezurl} id="confirmorder" name="confirmorder" data-errortext="{'Accept the terms and conditions to continue.'|i18n('extension/xrowecommerce')}" data-checkcos="{ezini( 'Settings', 'ConditionsOfService', 'xrowecommerce.ini')|eq('enabled')}">
