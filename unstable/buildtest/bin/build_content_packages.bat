...
cd C:\svn\xrowecommerce\unstable\buildtest\packages
...
XCOPY /Y /E /I C:\workspace\shop\var\storage\packages\local\xrowecommerce_classes C:\svn\xrowecommerce\unstable\buildtest\packages\xrowecommerce_classes
XCOPY /Y /E /I C:\workspace\shop\var\storage\packages\local\xrowecommerce_content C:\svn\xrowecommerce\unstable\buildtest\packages\xrowecommerce_content
