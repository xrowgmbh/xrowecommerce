...
{'SKU'|i18n( 'extension/harley' )}: {$product_item.item_object.contentobject.data_map.product_id.content|wash()}{$option_item.value}
{else}
{'SKU'|i18n( 'extension/harley' )}: {$prod.data_map.product_id.content|wash()}{$prod.data_map.variation.content.name|wash()}
{/if}

............................................................................................
{'Total'|i18n( 'extension/harley/email' )}: {$product_item.total_price_inc_vat|l10n( 'currency', $locale, $symbol )}
