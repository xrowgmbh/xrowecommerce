...
<h1 style="color: #f57900; font-family: 'Arial';">{"Search"|i18n("design/base")}</h1>

    <input class="halfbox" type="text" size="20" name="SearchText" id="Search" value="{$search_text|wash}" onfocus="this.select();" />
...
{section name=SearchResult loop=$search_result show=$search_result sequence=array(bglight,bgdark)}
        {node_view_gui view=linesearch sequence=$:sequence use_url_translation=$use_url_translation content_node=$:item}
{/section}
</table>
<br />
{include name=Navigator
