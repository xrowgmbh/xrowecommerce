{def $type=ezhttp("SearchPagetype", get)}
...
<form action={"/content/advancedsearch/"|ezurl} method="get">
    <div class="maincontentheader">
        {if and(is_set($type), $type|eq("knowitall"))}
            <h1 style="color: rgb(245, 121, 0); font-family: 'Arial';">Know it all</h1>
        {else}
            <h1 style="color: rgb(245, 121, 0); font-family: 'Arial';">{"Search"|i18n("design/standard/content/search")}</h1>
        {/if}
    </div>
    
    <div class="block" style="width: 350px;">
      <input class="box" type="text" size="20" name="SearchText" value="{$full_search_text|wash}" onfocus="this.select();" />
...
<form name="children" method="post" action={"/content/action"|ezurl()}>
    <input name="NodeID" value="70" type="hidden">
    <input name="ContentLanguageCode" value="eng-US" type="hidden">
    <input name="ClassID" value="21" type="hidden">
    <input name="ContentNodeID" value="70" type="hidden">
    <input name="ContentObjectID" value="68" type="hidden">
    <input name="ViewMode" value="full" type="hidden">

<p>
<h3>Does this answer your question?</h3>
<input type="image" src={"images/submitquestion.gif"|ezdesign()} name="NewButton" value="Create here" />
</p>
</form>
{/if}
</div>
