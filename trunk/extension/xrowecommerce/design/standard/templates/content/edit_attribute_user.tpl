...
*}
    <div style="width: 390px; float: left; display: inline; margin:5px; padding: 8px;">
        <div style="text-align: right;">
            <input class="left-arrow2" type="submit" /*src={"images/cancel_small.gif"|ezdesign()}*/ name="DiscardButton" value="{'Cancel'|i18n('design/base')}" />
            <input class="right-arrow" type="submit" src={"images/update.gif"|ezdesign()} name="PublishButton" value="Update">
