            ...
            <table>
                 ...
                 {section var=option_item loop=$product_item.item_object.option_list}
                    <tr>
                        ...
                        {def $vary2=$product_item.item_object.contentobject.data_map.variation.content.option_list[$product_item.item_object.option_list.0.option_item_id]}
                        {if $vary2.image|is_object(true)}
                            {if $vary2.image.current.data_map.image.has_content}
                            {attribute_view_gui image_class=small attribute=$vary2.image.current.data_map.image}
                            {/if}
                        {else}
                            {if $product_item.item_object.contentobject.data_map.image.has_content}
                            {attribute_view_gui image_class=small attribute=$product_item.item_object.contentobject.data_map.image}
