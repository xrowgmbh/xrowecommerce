...
class ShippingInterface
{
    ...
    {
    	$this->address_to = array ( "country" => $to_country, "state" => $to_state, "zip" => $to_zip, "city" => $to_city );
    }
    
    function setAddressFrom( $from_country, $from_state, $from_zip, $from_city)
    {
    	$this->address_from = array ( "country" => $from_country, "state" => $from_state, "zip" => $from_zip, "city" => $from_city );
    }
