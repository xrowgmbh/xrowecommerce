...
"C:\Program Files (x86)\Zend\Zend Studio - 7.0.1\plugins\org.zend.php.debug.debugger.win32.x86_5.2.26.v20090817\resources\php5\php-win.exe" ezpm.php -s ezwebin_site_admin add xrowecommerce_classes ezcontentclass xrow_product_category,xrow_product_review,xrow_product,manufacturer,coupon,client,xrow_package
...
"C:\Program Files (x86)\Zend\Zend Studio - 7.0.1\plugins\org.zend.php.debug.debugger.win32.x86_5.2.26.v20090817\resources\php5\php-win.exe" ezpm.php -s ezwebin_site_admin add xrowecommerce_content ezcontentobject --exclude-classes --exclude-templates --current-version "democontent/*" "manufacturer/*" "shop2" "news/*" "beer/*" "coupons/*" "packages/*" "products/*"
