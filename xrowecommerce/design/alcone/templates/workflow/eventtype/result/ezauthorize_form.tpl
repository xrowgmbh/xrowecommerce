...
<br />
    ...
    <div style="float: left; padding-left: 30px; color: #308d9d;">4. Payment info</div>
...
<tr>
<td colspan="2"><input type="image" name="CancelButton" value="{'Cancel'|i18n('design/standard/workflow')}" src={"images/cancel_small.gif"|ezdesign}/>&nbsp;&nbsp;<input type="image" name="validate" value="Submit" src={"images/submit.gif"|ezdesign} /></td>
</tr>
</table>
</td>
...
<div>
<img src="http://usa.visa.com/img/cards/cardart_3Digit_code.gif" class="" alt="" title="" style="margin-top:0px;" /><br />
