...
<tr><th>{'Country'|i18n('design/standard/shop')}:</th><td>{$order.account_information.country}</td></tr>
...
<tr><th>{'Country'|i18n('design/standard/shop')}:</th><td>{$order.account_information.s_country}</td></tr>
