...
class xrowComDirectInfo
{
    ...
    */
    ...
    function validateECData( &$contentObjectAttribute, &$classAttribute, $data )
    {
        ...
        {
            $contentObjectAttribute->setValidationError( ezi18n( 'kernel/classes/datatypes',
                                                                 'Please enter your correct account number (max. 10 numbers)' ) );
            return false;
        }
        if ( !preg_match( "/^[0-9]{8}$/", $data['bankcode'] )  )
        {
            $contentObjectAttribute->setValidationError( ezi18n( 'kernel/classes/datatypes',
                                                                 'Please enter your correct bank code (8 numbers)' ) );
            return false;
        }
        ...
        if ( !$testMode )
        {
            ...
            {
                $contentObjectAttribute->setValidationError( ezi18n( 'kernel/classes/datatypes',
                                                                 'The account number or the bank code was not accepted.
