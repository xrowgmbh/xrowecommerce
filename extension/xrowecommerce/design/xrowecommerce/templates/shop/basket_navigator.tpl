<div class="shopping_cart_path">
            ...
            <div {if $step|eq('2')} class="shopping_cart_path_select"{/if}>2. 
            ...
            <div {if $step|eq('5')} class="shopping_cart_path_select"{/if}>5. {'Completion'|i18n('extension/xrowecommerce')}</div>
