    ...
    <div style="border: 1px solid #ebeeef; width: 390px; float: left; display: inline; margin:5px; padding: 8px;">
        ...
        <table border="0">
	        <tr>
		        ...
		        <td>
		            <p>{'My billing and shipping addresses are identical.'|i18n('extension/xrowecommerce')}</p>
		        </td>
	        </tr>
        </table>
...
<div style="width: 90px; display: inline; float: left;">
    ...
    {if $ca.creditcard}
        <div style="border: 1px solid #ebeeef; width: 390px; float: left; display: inline; margin:5px; padding: 8px;">
        <span class="heading1">{'Credit card Information'|i18n('extension/xrowecommerce')}</span><br />
        <p>
